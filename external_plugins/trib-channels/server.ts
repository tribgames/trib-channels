...
// Load trib-channels Memory System context (generated by memory-cycle)
...
backend.onInteraction = (interaction: BackendInteraction) => {
  ...
  if (interaction.customId?.startsWith('perm-')) {
    ...
    if (access.allowFrom && access.allowFrom.length > 0 && !access.allowFrom.includes(interaction.userId)) {
