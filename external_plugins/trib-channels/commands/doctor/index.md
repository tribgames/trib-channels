---
description: Diagnose trib-channels configuration and connectivity issues.
allowed-tools:
  - Read
  - Bash(node *)
  - Bash(which *)
...
- Fix: "Run /trib-channels setup to create the config"
...
- Fix: "Open /trib-channels setup and review Channels & Access"
...
- Fix: "Run /trib-channels setup to configure channels"
...
[FAIL] Access control: no users or channels configured
       Fix: Open /trib-channels setup and update Channels & Access
