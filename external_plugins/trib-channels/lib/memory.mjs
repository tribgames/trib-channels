...
function isTranscriptQuarantineContent(text) {
  ...
  if (/output json only/i.test(clean) && /(memory system|trib-channels|c2b)/i.test(clean)) return true
  return false
}
  ...
  init() {
    ...
    this.db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS episodes (
        ...
        backend TEXT NOT NULL DEFAULT 'trib-channels',
        channel_id TEXT,
        user_id TEXT,
        user_name TEXT,
        session_id TEXT,
