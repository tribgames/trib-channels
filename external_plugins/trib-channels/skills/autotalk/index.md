---
description: Explain trib-channels Autotalk — proactive conversation feature where the bot initiates topics based on context and memory.
user_invocable: true
---

# Autotalk

Autotalk is a proactive conversation feature. When enabled, trib-channels occasionally initiates conversations based on recent context, memory, and user interests.
