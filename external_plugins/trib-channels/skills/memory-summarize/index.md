---
description: Explain trib-channels Memory Summarize — automatic daily conversation summarization, memory system, and manual execution.
user_invocable: true
---
...
All files are stored in `~/.claude/plugins/data/trib-channels-trib-channels/history/`:
