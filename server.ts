...
if (process.env.CLAUDE2BOT_NO_CONNECT) {
  ...
  void (async () => {
    ...
    await mcp.notification({
      method: 'notifications/claude/channel',
      params: {
        content: 'New session started. Say something different each time — vary your tone, topic, or style. You can mention recent work, ask a question, share a thought, or just be casual. Never repeat the same greeting pattern. One short message only, no tools.',
